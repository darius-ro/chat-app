...
const LOCALSTORAGE_AUTH_NAME = process.env.NEXT_PUBLIC_AUTH_LOCALSTORAGE_NAME ?? "_auth"
...
export const AuthProvider = ({ children }:Readonly<{ children: React.ReactNode }>) => {
    ...
    return (
        <AuthContext.Provider value={{ user, loading, CheckUserAuth, SetAuthToken, DeleteAuthToken }}>
            {children}
